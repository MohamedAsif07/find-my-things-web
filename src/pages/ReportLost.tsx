    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-2xl">
          <div className="mb-8">
            <h1 className="mb-2 text-4xl font-bold">Report Lost Item</h1>
            <p className="text-muted-foreground">
              Fill in the details to help others identify your lost item
            </p>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide as much information as possible to increase chances of recovery
              </CardDescription>
            </CardHeader>
            <CardContent>
